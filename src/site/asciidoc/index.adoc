...
[quote, John Carmack - Oculus VR CTO]
...
Determine a path with small steps and start to work on it.
--
...
The technological objectives are not there to have fun technically (ok maybe a little...).
...
- a salary that is in line with the responsibilities and the standard of living that the person desires
- a pace of work that allows to have a correct professional / personal life balance
- a favorable context
...
Separating from a person does not necessarily mean that the person loses his job.
